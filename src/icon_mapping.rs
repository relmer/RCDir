// RCDir - Nerd Font Icon Mapping
// Named constants and default lookup tables for file/directory icons.
//
// All Nerd Font code points are sourced from NF v3.4.0 / Terminal-Icons theme.
// Grouped by NF prefix, alphabetical within each group.


////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Custom (nf-custom-*)
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Font Awesome Extension (nf-fae-*)
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Octicons (nf-oct-*)
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Font Awesome (nf-fa-*)
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Material Design (nf-md-*) — supplementary plane
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  Named Constants — Codicons (nf-cod-*)
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  DEFAULT_EXTENSION_ICONS
//
//  Static table mapping file extensions to Nerd Font icon glyphs.
//  Keys are lowercase with leading dot (matching Config convention).
//  Sourced from TCDir/TCDirCore/IconMapping.cpp.
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//
//  DEFAULT_WELL_KNOWN_DIR_ICONS
//
//  Static table mapping well-known directory names to Nerd Font icon glyphs.
...
mod tests {
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_extension_table_no_duplicate_keys
    //
    //  Verify no duplicate extension keys in DEFAULT_EXTENSION_ICONS.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_extension_table_no_duplicate_keys() {
        let mut seen = HashSet::new();
        for &(key, _) in DEFAULT_EXTENSION_ICONS {
            assert! (seen.insert (key), "Duplicate extension key: {}", key);
        }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_extension_keys_are_lowercase_with_dot
    //
    //  All extension keys must be lowercase and start with '.'.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_extension_keys_are_lowercase_with_dot() {
        for &(key, _) in DEFAULT_EXTENSION_ICONS {
            assert! (key.starts_with ('.'), "Key must start with '.': {}", key);
            assert_eq! (key, key.to_ascii_lowercase(), "Key must be lowercase: {}", key);
        }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_well_known_dir_table_no_duplicate_keys
    //
    //  Verify no duplicate keys in DEFAULT_WELL_KNOWN_DIR_ICONS.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_well_known_dir_table_no_duplicate_keys() {
        let mut seen = HashSet::new();
        for &(key, _) in DEFAULT_WELL_KNOWN_DIR_ICONS {
            assert! (seen.insert (key), "Duplicate well-known dir key: {}", key);
        }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_well_known_dir_keys_are_lowercase
    //
    //  All well-known directory keys must be lowercase.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_well_known_dir_keys_are_lowercase() {
        for &(key, _) in DEFAULT_WELL_KNOWN_DIR_ICONS {
            assert_eq! (key, key.to_ascii_lowercase(), "Key must be lowercase: {}", key);
        }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_extension_table_count
    //
    //  Verify the extension table has the expected number of entries.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_extension_table_count() {
        // Data model specifies ~209 entries; verify >= 180 as a baseline
        assert! (DEFAULT_EXTENSION_ICONS.len() >= 180,
            "Expected >=180 extension entries, got {}", DEFAULT_EXTENSION_ICONS.len());
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_well_known_dir_table_count
    //
    //  Verify the well-known dir table has the expected number of entries.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_well_known_dir_table_count() {
        // Data model specifies 60 entries; verify >= 55 as a baseline
        assert! (DEFAULT_WELL_KNOWN_DIR_ICONS.len() >= 55,
            "Expected >=55 well-known dir entries, got {}", DEFAULT_WELL_KNOWN_DIR_ICONS.len());
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //
    //  test_all_glyphs_are_valid_unicode
    //
    //  All icon glyphs must be valid NF Private Use Area code points.
    //
    ////////////////////////////////////////////////////////////////////////////

    #[test]
    fn test_all_glyphs_are_valid_unicode() {
        let is_nf_range = |c: char| -> bool {
            let cp = c as u32;
            // Nerd Font PUA ranges: BMP PUA (E000–F8FF) and Supplementary PUA (F0000–FFFFF)
            (0xE000..=0xF8FF).contains (&cp) || (0xF0000..=0xFFFFF).contains (&cp)
        };

        for &(key, glyph) in DEFAULT_EXTENSION_ICONS {
            assert! (is_nf_range (glyph),
                "Extension '{}' has glyph U+{:04X} outside NF PUA range", key, glyph as u32);
        }
